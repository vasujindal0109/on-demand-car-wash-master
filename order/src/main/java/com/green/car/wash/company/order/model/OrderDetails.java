...
public class OrderDetails {
	...
	public OrderDetails(String orderId, @NotEmpty(message = "Email Can't be empty") String useremailid,
			...
			@NotEmpty(message = "status can't be empty") String status, String username,
	...
	public String toString() {
		return "OrderDetails [orderId=" + orderId + ", useremailid=" + useremailid + ", washerName=" + washerName
				+ ", washpacks=" + washpacks + ", phoneNo=" + phoneNo + ", areapincode=" + areapincode + ", status="
				+ status + ", username=" + username + ", cars=" + cars + "]";
	}
